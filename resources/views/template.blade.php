...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{asset('storage/image/'.$item->foto)}}"alt="Product 1" style="width:100%; border-radius:10%" alt="Image">
                    <div class="card-body">
                        ...
                        <a href="/detailproduk/{{$item->id}}" class="btn btn-warning"style="margin-left: 80px; width:50%;">Beli</a>
                    </div>
                  </div>
            </div>
                @endforeach
